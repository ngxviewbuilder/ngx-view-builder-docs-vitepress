...
The agent also draws on the human documentation — [element pages](../creators/elements/), [expressions](../creators/expressions), [conditional logic](../creators/conditional-logic), [validation](../creators/validation), [events & actions](../creators/events-actions), [data sources](../creators/data-sources), [variables](../creators/variables) — and on library source files (interfaces, enums, property datasets), which are always the final source of truth.
