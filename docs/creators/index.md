---
title: Angular form builder for creators
description: Build Angular forms, dashboards, and data views without writing code. Drag elements onto a canvas, set their properties in a sidebar, and save the result as JSON.
---
...
::: tip Names matter
Give every value-producing element a short, stable name like `firstName` or `deliveryDate`. Names become data keys and are how expressions reference other fields, as in `{firstName}`.
:::
