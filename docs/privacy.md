...
**Contacting us.** If you email us, we process your email address and message content only to respond to you.
...
We use **Google Analytics** (Google Ireland Limited) as a data processor for the analytics described above. Google's own privacy policy and data-transfer safeguards apply to its processing: [policies.google.com/privacy](https://policies.google.com/privacy). We do not sell your data or share it with any other third party.

## Retention

Analytics data is retained according to our Google Analytics account settings. Emails are kept as long as needed to handle your inquiry and any follow-up.
...
The Site is not directed at children, and we do not knowingly collect data from them.
